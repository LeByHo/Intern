...
public class total_Fragment extends Fragment { BarChart barChart;
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        barChart.setDescription("hihihii");
...
/*
        ...
        entries.add(new BarEntry(8f, 1));Z
        ...
        final BarDataSet barDataSet1 = new BarDataSet(group1, "SM5");
        barDataSet1.setColor(Color.rgb(032, 178, 170));

        barDataSet1.setDrawValues(false);
        //barDataSet1.setColors(ColorTemplate.COLORFUL_COLORS);

        BarDataSet barDataSet2 = new BarDataSet(group2, "제네시스");
